...
#    Updated: 2025/07/09 19:55:40 by omizin           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = minishell.c helpers.c env_helpers.c signals.c free_functions.c commands.c commands_helpers.c commands_second_part.c small_helpers.c billy.c
